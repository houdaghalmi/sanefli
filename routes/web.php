...
Route::middleware(['auth', 'role:user'])->name('user.')->group(function () {
    Route::get('/user/dashboard', [ProfileController::class, 'index'])->name('dashboard');
    ...
    Route::get('/autocomplete/ingredients', [UserRecipeController::class, 'autocompleteIngredients'])->name('recipes.autocomplete');
