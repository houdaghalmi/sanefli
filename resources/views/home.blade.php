...
<link rel="apple-touch-icon" href="{{ asset('build/assets/images/apple-touch-icon.png') }}">
...
<!-- Color Theme CSS -->
<link id="changeable-colors" rel="stylesheet" href="{{ asset('build/assets/css/colors/orange.css') }}">

<!-- Modernizer JS -->
<script src="{{ asset('build/assets/js/modernizer.js') }}"></script>
                ...
                <div class="banner-static">
                    <div class="banner-text">
                        <div class="banner-cell">
                            ...
                            <div class="book-btn">
                                <a href="#reservation" class="table-btn hvr-underline-from-center">Rejoindre Sanefli !!
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <h3>It all started quite simply  with a passion for good food...</h3>
                        <p> Sanefli was born from a simple idea: sometimes, you just don’t know what to cook — and that’s okay.
                            With Sanefli, all you have to do is enter the ingredients you have, and we’ll help you discover recipes that match. Our goal is to make cooking easier, more fun, and more inspiring for everyone.</p>

                        <p> Our platform brings together a growing community of food lovers who share tips, creative ideas, and homemade dishes. From healthy meals to sweet treats and savory delights, Sanefli helps you find the perfect recipe for your taste, your mood, and your lifestyle.

                        </p>

                        <p> Cooking is not just about following steps—it’s about creativity, passion, and sharing. At Sanefli, we believe that every meal is a story, and we’re here to help you write yours.

                            Join us and let your taste buds travel!</p>
                    </div>
                </div>
                <!-- end col -->
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <h5 class="title-caption text-center"> Not sure what to cook today? Let Sanefli surprise you!. </h5>
                    </div>
